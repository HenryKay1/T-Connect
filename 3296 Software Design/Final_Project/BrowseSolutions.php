   ...
   <body id="page-top">
         ...
         <div class="container-fluid">
            ...
            <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
               <div class="input-group">
                  <input id = "searchInput" class="bg-light form-control border-0 small" type="text" placeholder="Look up Question">
               ...
               <li class="nav-item dropdown d-sm-none no-arrow">
                  ...
                  <div class="dropdown-menu dropdown-menu-right p-3 animated--grow-in" aria-labelledby="searchDropdown">
                     <form class="form-inline mr-auto navbar-search w-100">
                        <div class="input-group">
                           <input class="bg-light form-control border-0 small" type="text"  placeholder="Look up Question">
      ...
      <?php
         ...
         ";  //Get Controversial Solution for each course
          ...
          $html = '
          <div id = "sb"><p class= "fancytitle"   ><strong>Controversial solutions for your ongoing courses</strong></p>
         <br>
          <div class="slideshow-container" style ="width: 60vv;  background:#b3ffff">
      ...
      <script>
         ...
         if(sessionStorage.getItem("QID") =='0'){
         	alert("haha its over");
         }
