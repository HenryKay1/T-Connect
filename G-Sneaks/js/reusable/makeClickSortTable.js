function makeClickSortTable(mainObj) {  //title, objList, sortOrderPropName, sortIcon
    ...
    searchDiv.appendChild(insertSpan);
    insertSpan.innerHTML = " &nbsp;&nbsp;&nbsp; <b>"+mainObj.insertObj.header+"<b/> "; //&nbsp;&nbsp;&nbsp;<img  style= 'padding: 0px;'src = '"+ mainObj.insertObj.icon+"'>";
     
    var insertImg = document.createElement("img");
    insertImg.onclick = mainObj.insertObj.onClick;
    insertImg.src= mainObj.insertObj.icon;
    searchDiv.appendChild(insertImg);
