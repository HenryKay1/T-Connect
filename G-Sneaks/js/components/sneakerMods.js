...
// Properties that are "global" to this IIFE: 
    ...
    function insertSave() {
        ...
        ajax("webAPIs/insertSneakersAPI.jsp?jsonData=" + myData, reportInsert, recordError);
        function reportInsert(jsErrorObj) {

            console.log("SneakerMods.insert/insertSave/processInsert error msg obj (see next line)");
