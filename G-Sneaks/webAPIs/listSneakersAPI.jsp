<%-- 
    Document   : listSneakers
    Created on : Mar 4, 2021, 7:50:18 PM
    Author     : henry
--%>
...
<%@page language="java" import="model.sneakers.StringData" %> 
<%@page language="java" import="model.sneakers.StringDataList" %> 
...
<%
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        list = sneakersView.getAllUsers(dbc);
