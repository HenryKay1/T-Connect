...
// Properties that are "global" to this IIFE: 
    ...
    function writeErrorObjToUI(jsObj) {
        ...
        console.log(jsObj);
        validateObjList["userEmail"].errorTd.innerHTML = jsObj.userEmail;
        validateObjList["userPassword"].errorTd.innerHTML = jsObj.userPassword;
        validateObjList["userPassword2"].errorTd.innerHTML = jsObj.userPassword2;
        validateObjList["image"].errorTd.innerHTML = jsObj.image;
        validateObjList["birthday"].errorTd.innerHTML = jsObj.birthday;
        validateObjList["membershipFee"].errorTd.innerHTML = jsObj.membershipFee;
        validateObjList["userRoleId"].errorTd.innerHTML = jsObj.userRoleId;
